...
<body class="flex flex-col items-center justify-center min-h-screen w-screen bg-gray-100">
    <!-- FRONT SIDE -->
    <div class="border border-gray-400 bg-white flex flex-col justify-between p-2 w-[3.5in] h-[2.5in] mb-8">
        <!-- --- FRONT CONTENT (copy from parent_id.php) --- -->
        <div>
    ...
    <div class="border border-gray-400 bg-white flex flex-col justify-between p-2 w-[3.5in] h-[2.5in]">
        <!-- --- BACK CONTENT (copy from back_id.php) --- -->
